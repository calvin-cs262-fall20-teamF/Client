 ...
 *
 * reportPage.js displays a list of activity status buttons
 * for the user to report on a location's busyness. 
 ***************************************************************/
...
/**
   ...
   * @return JSX to display button list and submit button
   */
export default function Report({ route, navigation }) {
   ...
   * 
   * Calls an anonymous function that changes the active 
   * and inactive buttons' appearances based on what the user 
   * selected. Also changes the submit button's appearance and
   * the user's ability to press it.
   * 
   * @param {number} - ID of the active button
   */
   ...
   * Pushes data for ActivityStatus and LocationID; ReportedTime is 
   * automatically generated by PostgreSQL
   */
  const submitHandler = () => {
      fetch('https://calvinfreespace.herokuapp.com/statusreports', {
          method: 'POST',
          headers: {
          ...
          body: JSON.stringify({
              status: activeButtonValue,
              locationid: route.params.key,
          })
      });
